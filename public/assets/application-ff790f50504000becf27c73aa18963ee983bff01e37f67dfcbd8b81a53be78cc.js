...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    uploadClass: 'btn btn-sm btn-kv btn-outline-primary',
                    uploadTitle: 'Upload file',
                    uploadRetryIcon: '<i class="fas fa-repeat"></i>',
                    uploadRetryTitle: 'Retry upload',
                    downloadIcon: '<i class="fas fa-download"></i>',
                    downloadClass: 'btn btn-sm btn-kv btn-outline-primary',
                    downloadTitle: 'Download file',
                    zoomIcon: '<i class="fas fa-search-plus"></i>',
                    zoomClass: 'btn btn-sm btn-kv btn-outline-primary',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonClasses: {
            ...
            toggleheader: 'btn btn-sm btn-kv btn-outline-primary',
            fullscreen: 'btn btn-sm btn-kv btn-outline-primary',
            borderless: 'btn btn-sm btn-kv btn-outline-primary',
            close: 'btn btn-sm btn-kv btn-outline-primary'
        },
        ...
        cancelClass: 'btn btn-primary btn-primary',
        uploadIcon: '<i class="fas fa-upload"></i>',
        uploadClass: 'btn btn-primary btn-primary',
        uploadUrl: null,
        uploadUrlThumb: null,
        uploadAsync: true,
        uploadExtraData: {},
