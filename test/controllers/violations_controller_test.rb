...
class ViolationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create violation" do
    assert_difference('Violation.count') do
      post violations_url, params: { violation: { reason: @violation.reason, user_id: @violation.user_id } }
    end
  ...
  test "should update violation" do
    patch violation_url(@violation), params: { violation: { reason: @violation.reason, user_id: @violation.user_id } }
